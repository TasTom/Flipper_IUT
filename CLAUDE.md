...
| **Claude** | Écrit tous les scripts C# (`Assets/Scripts/`), les ScriptableObjects de config, les scripts d'éditeur, et pilote l'éditeur via le CLI Unity pour vérifier/outiller. |
